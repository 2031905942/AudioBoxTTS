...
from qfluentwidgets import BodyLabel, CaptionLabel, InfoBar, InfoBarPosition, LineEdit, MessageBoxBase, SubtitleLabel
...
class CharacterDialog(MessageBoxBase):
    ...
    def _get_project_root() -> str:
        ...
        # .../Source/UI/Interface/AIVoiceInterface/dialogs/character_dialog.py -> repo root
