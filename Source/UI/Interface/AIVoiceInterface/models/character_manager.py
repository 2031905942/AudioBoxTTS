...
class CharacterManager:
    ...
    def __init__(self, config_dir: Optional[str] = None, project_id: Optional[str] = None):
        ...
        if project_id is None:
            if config_dir is None:
                ...
                # .../Source/UI/Interface/AIVoiceInterface/models/character_manager.py -> repo root
    ...
    def _load_from_config_utility(self):
        ...
        try:
            self._characters = [Character.from_dict(c) for c in characters_data.get("characters", [])]
    ...
    def _load_from_json_file(self):
        ...
        try:
            ...
            self._characters = [Character.from_dict(c) for c in data.get("characters", [])]
    ...
    def update_last_output(self, character_id: str, output_dir: str, filename: str) -> bool:
        """更新角色的上次输出路径"""
        return self.update(character_id, last_output_dir=output_dir, last_output_filename=filename)
    ...
    def get_suggested_output_path(self, character_id: str) -> tuple[str, str]:
        ...
        if not output_dir:
            ...
            output_dir = QStandardPaths.writableLocation(QStandardPaths.StandardLocation.MusicLocation)
